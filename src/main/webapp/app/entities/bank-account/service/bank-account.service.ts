...
export class BankAccountService {
  ...
  update(bankAccount: IBankAccount): Observable<EntityResponseType> {
    return this.http.put<IBankAccount>(`${this.resourceUrl}/${getBankAccountIdentifier(bankAccount) as string}`, bankAccount, {
      observe: 'response',
    });
  }

  partialUpdate(bankAccount: IBankAccount): Observable<EntityResponseType> {
    return this.http.patch<IBankAccount>(`${this.resourceUrl}/${getBankAccountIdentifier(bankAccount) as string}`, bankAccount, {
      observe: 'response',
    });
  }
