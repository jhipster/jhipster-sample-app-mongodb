(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jhipsterMongodbSampleApplicationApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jhipsterMongodbSampleApplicationApp-error');
                var entityKey = httpResponse.headers('X-jhipsterMongodbSampleApplicationApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('jhipsterMongodbSampleApplicationApp.' + fieldError.objectName + '.' + convertedField);
