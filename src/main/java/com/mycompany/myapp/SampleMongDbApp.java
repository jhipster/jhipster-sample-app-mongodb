...
public class SampleMongDbApp {

    private static final Logger log = LoggerFactory.getLogger(SampleMongDbApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes sampleMongDB.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SampleMongDbApp.class);
