...
describe('Service Tests', () => {
    ...
    describe('BankAccount Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BankAccountService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/bank-accounts/' + '123');
            });
            it('should return BankAccount', () => {

                let entity: BankAccount;
                service.find('123').subscribe((_entity: BankAccount) => {
                    entity = _entity;
                });
