    ...
    describe('BankAccount Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a BankAccount', () => {
                service.create(new BankAccount(null)).subscribe(received => {
            ...
            it('should update a BankAccount', () => {
                service.update(new BankAccount('123')).subscribe(received => {
            ...
            it('should return a BankAccount', () => {
