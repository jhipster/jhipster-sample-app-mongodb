...
describe('BankAccount e2e test', () => {
    ...
    it('should load BankAccounts', async () => {
        ...
        expect(await bankAccountComponentsPage.getTitle()).toMatch(/jhipsterMongodbSampleApplicationApp.bankAccount.home.title/);
    });
    ...
    it('should load create BankAccount page', async () => {
        ...
        expect(await bankAccountUpdatePage.getPageTitle()).toMatch(
            /jhipsterMongodbSampleApplicationApp.bankAccount.home.createOrEditLabel/
        );
    ...
    it('should delete last BankAccount', async () => {
        ...
        expect(await bankAccountDeleteDialog.getDialogTitle()).toMatch(/jhipsterMongodbSampleApplicationApp.bankAccount.delete.question/);
