...
describe('BankAccount e2e test', () => {
    ...
    it('should load BankAccounts', async () => {
        ...
        expect(await bankAccountComponentsPage.getTitle()).to.eq('jhipsterMongodbSampleApplicationApp.bankAccount.home.title');
    });
    ...
    it('should load create BankAccount page', async () => {
        ...
        expect(await bankAccountUpdatePage.getPageTitle()).to.eq('jhipsterMongodbSampleApplicationApp.bankAccount.home.createOrEditLabel');
    ...
    it('should delete last BankAccount', async () => {
        ...
        expect(await bankAccountDeleteDialog.getDialogTitle()).to.eq('jhipsterMongodbSampleApplicationApp.bankAccount.delete.question');
