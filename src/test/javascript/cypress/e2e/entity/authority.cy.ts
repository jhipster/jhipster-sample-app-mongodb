...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'e254e83d-61f9-4d53-ab71-dd1b35548c14' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('3176a938-4620-4fcc-8b50-dbccd2d8da47');
      cy.get(`[data-cy="name"]`).should('have.value', '3176a938-4620-4fcc-8b50-dbccd2d8da47');
